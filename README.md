...
### 메인 화면
- [X] 메인 선택지 경로 조회, 종료 화면 출력
- [X] 원하는 기능 선택 입력
- [X] 입력 명령어에 따른 함수 실행

### 경로 조회 화면
- [X] 최단거리, 최소 시간, 돌아가기 선택지 화면 출력
- [X] 경로 조회 선택 입력
- [X] 입력 명령어에 따른 함수 실행
...
- [X] 총 거리 계산
- [X] 총 소요 시간 계산
- [X] 총 거리, 총 소요 시간, 경로들 출력하기.
- [X] 조회 결과 출력 -> 총 거리, 총 소요 시간, 경로들 출력
...
- 총 거리 계산
- 총 소요시간 계산
- 총 거리, 총 소요 시간, 경로들 출력하기
- 조회 결과 출력 -> 총 거리, 총 소요 시간, 경로들 출력

### 예외 상황
- [X] [ERROR] 출발역과 도착역이 동일합니다.
- [ ] [ERROR] 존재하지 않는 역입니다.
- [X] [ERROR] 연결되지 않은 역입니다.
